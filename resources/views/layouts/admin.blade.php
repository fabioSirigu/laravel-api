    ...
    <div id="app">
        <header class="navbar sticky-top flex-md-nowrap shadow">
            <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="#">
                <img class="logo_nazone" src="../img/logoNazOne.png" alt="">
            </a>
            ...
            <ul class="navbar-nav ml-auto px-5">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right position-absolute logout_dropdown" aria-labelledby="navbarDropdown">
                        ...
                        <ul class="nav flex-column p-2">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{route ('admin.projects.index')}}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 640 512"><!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
